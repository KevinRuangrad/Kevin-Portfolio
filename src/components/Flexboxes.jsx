...
>
  <a href="https://www.linkedin.com/in/kevin-ruangrad-0696232b2/" target="_blank" rel="noopener noreferrer" className="button-link" draggable="false" onDragStart={(e) => e.preventDefault()}>
    <motion.button
...
<Block
  ...
  className="flex text-center justify-center"
>
  <a href="https://github.com/KevinRuangrad" target="_blank" rel="noopener noreferrer" className="button-link" draggable="false" onDragStart={(e) => e.preventDefault()}>
    <motion.button
      whileHover={{ scale: 1.1 }}
      whileTap={{ scale: 0.95 }}
      className="text-white text-[20px] font-medium tracking-tighter"
...
<Block
  ...
  className="flex text-center justify-center"
>
  <a href="https://www.instagram.com/kevinruangrad_/" target="_blank" rel="noopener noreferrer" className="button-link" draggable="false" onDragStart={(e) => e.preventDefault()}>
    <motion.button
      whileHover={{ scale: 1.1 }}
      whileTap={{ scale: 0.95 }}
      className="text-white text-[20px] font-medium tracking-tighter"
...
<Block
  ...
  className="flex text-center justify-center"
>
  <a href="https://www.facebook.com/kruangrad/?locale=sv_SE" target="_blank" rel="noopener noreferrer" className="button-link" draggable="false" onDragStart={(e) => e.preventDefault()}>
    <motion.button
      whileHover={{ scale: 1.1 }}
      whileTap={{ scale: 0.95 }}
      className="text-white text-[20px] font-medium tracking-tighter"
